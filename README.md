...
## Субд и Data access level: 
MSSQL Server, PostgreSQL, MongoDB.
DAL: Entity Framework (code first), Dapper и Linq.
Опыт работы с бизнес логикой на уровне базы данных через хранимые процедуры, view, тригеры, временные таблицы и т.д. 
